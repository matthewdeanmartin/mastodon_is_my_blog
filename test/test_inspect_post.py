...
def test_analyze_content_domains_sets_flags_from_links_media_and_question() -> None:
    ...
    flags = analyze_content_domains(html=html, media_attachments=media_attachments, is_reply_to_other=False)
...
def test_analyze_content_domains_ignores_mentions_hashtags_and_quote_posts() -> None:
    ...
    flags = analyze_content_domains(html=html, media_attachments=[], is_reply_to_other=False)
...
def test_analyze_content_domains_skips_question_flag_for_replies() -> None:
    ...
    flags = analyze_content_domains(html=html, media_attachments=[], is_reply_to_other=True)
