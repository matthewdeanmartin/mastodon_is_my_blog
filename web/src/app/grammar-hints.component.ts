        ...
        ">
          ...
          @if (m.replacements.length > 0) {
            <div style="display: flex; flex-wrap: wrap; gap: 4px; margin-top: 6px;">
              <span style="font-size: 0.75rem; color: #6b7280; align-self: center;">Replace with:</span>
